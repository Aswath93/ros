...
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
      Default.abstract_parameters.push_back(HoughCirclesConfig::AbstractParamDescriptionConstPtr(new HoughCirclesConfig::ParamDescription<int>("debug_image_type", "int", 0, "Select image type for debug output", "{'enum_description': 'An enum for debug view', 'enum': [{'srcline': 53, 'description': 'Input image', 'srcfile': '/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg', 'cconsttype': 'const int', 'value': 0, 'ctype': 'int', 'type': 'int', 'name': 'Input'}, {'srcline': 54, 'description': 'GaussianBlur image', 'srcfile': '/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg', 'cconsttype': 'const int', 'value': 1, 'ctype': 'int', 'type': 'int', 'name': 'Blur'}, {'srcline': 55, 'description': 'Canny edge image', 'srcfile': '/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg', 'cconsttype': 'const int', 'value': 2, 'ctype': 'int', 'type': 'int', 'name': 'Canny'}]}", &HoughCirclesConfig::debug_image_type)));
//#line 262 "/opt/ros/indigo/lib/python2.7/dist-packages/dynamic_reconfigure/parameter_generator_catkin.py"
...
//#line 53 "/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg"
      const int HoughCircles_Input = 0;
//#line 54 "/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg"
      const int HoughCircles_Blur = 1;
//#line 55 "/home/aswath/ros/src/opencv_apps/cfg/HoughCircles.cfg"
